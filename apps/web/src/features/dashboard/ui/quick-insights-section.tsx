...
const getInsightBadgeStyle = (type: InsightType) => {
  switch (type) {
    ...
    case "usage":
      return "bg-orange-500/10 text-orange-600 dark:bg-orange-400/10 dark:text-orange-400";
    case "recommendation":
        ...
        {isLoading ? (
          ...
          <div className="space-y-6">
            {sortedInsights.map((insight) => (
              <div
                key={insight.id}
                className="py-6 border-b border-border/10 last:border-b-0"
              >
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1 space-y-2">
                      <div className="flex items-center space-x-3">
                        ...
                        <span
                          className={`text-xs px-2 py-1 rounded-full font-medium tracking-wide ${getInsightBadgeStyle(insight.type)}`}
                        >
